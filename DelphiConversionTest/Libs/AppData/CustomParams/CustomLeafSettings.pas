{ --------------------------------------------------------------------------------------------------
  ...
  01.03.13 wl  TCustomSetting_RackOfRackPosArray         TN6101   erweitert auf RackName-Array
  05.03.13 wl  TCustomSetting_...ArrayRefToRackPos       TN6101   neue Klassen
...
type
    TCustomSetting_ReferringToRackPosArray = class(TCustomLeafSetting)
    strict private
        fColumnDescription: string;
        fColumnWidth: integer;
    public
        constructor Create(const aKey, aDescription, aColumnDescription: string; aColumnWidth: integer;
        ...
        property ColumnDescription: string read fColumnDescription;
    ...
    TCustomSetting_DilNameArrayRefToRackPos = class(TCustomSetting_ReferringToRackPosArray)
    public
        constructor Create(const aKey, aDescription: string; aOnAddEditFunctions: TNotifyEvent;
            aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
    end;

    TCustomSetting_DiluentRack = class(TCustomLeafSetting)
    public
        constructor Create(const aKey, aDescription: string; aOnAddEditFunctions: TNotifyEvent;
            aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
    end;

    TCustomSetting_DilRackArrayRefToRackPos = class(TCustomSetting_ReferringToRackPosArray)
    public
        constructor Create(const aKey, aDescription: string; aOnAddEditFunctions: TNotifyEvent;
            aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
    end;
    ...
    TCustomSetting_LiqParamArrayRefToRackPos = class(TCustomSetting_ReferringToRackPosArray)
    public
        constructor Create(const aKey, aDescription: string; aOnAddEditFunctions: TNotifyEvent;
            aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
    end;
    ...
    TCustomSetting_PosOfRackPosArray = class(TCustomLeafSetting)
    public
        constructor Create(const aKey: string; const aDescription: string; aOnAddEditFunctions: TNotifyEvent;
            aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
    end;

    TCustomSetting_PosArrayRefToRackPos = class(TCustomSetting_ReferringToRackPosArray)
    public
        constructor Create(const aKey, aDescription, aColumnDescription: string;
    ...
    TCustomSetting_RackOfRackPosArray = class(TCustomLeafSetting)
    public
        constructor Create(const aKey: string; const aDescription: string; aOnAddEditFunctions: TNotifyEvent;
            aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
    end;

    TCustomSetting_RackArrayRefToRackPos = class(TCustomSetting_ReferringToRackPosArray)
    public
        constructor Create(const aKey, aDescription, aColumnDescription: string;
            aOnAddEditFunctions: TNotifyEvent;
            aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
    ...
    TCustomSetting_SubstIDArrayRefToRackPos = class(TCustomSetting_ReferringToRackPosArray)
    public
        constructor Create(const aKey, aDescription, aColumnDescription: string;
            aOnAddEditFunctions: TNotifyEvent;
            aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
    ...
    TCustomSetting_TipArrayRefToRackPos = class(TCustomSetting_ReferringToRackPosArray)
    public
        constructor Create(const aKey, aDescription: string; aOnAddEditFunctions: TNotifyEvent;
            aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
    end;
    ...
    TCustomSetting_VolumeArrayRefToRackPos = class(TCustomSetting_ReferringToRackPosArray)
    public
        constructor Create(const aKey, aDescription, aColumnDescription: string;
            aOnAddEditFunctions: TNotifyEvent;
            aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
...
{ TCustomSetting_ReferringToRackPosArray }

constructor TCustomSetting_ReferringToRackPosArray.Create(const aKey, aDescription,
    aColumnDescription: string; aColumnWidth: integer; aEditType: TCustomSettingEditType;
    aOnAddEditFunctions: TNotifyEvent; aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, true, aEditType, aOnAddEditFunctions, aOnGetEditFunctionParams);
...
constructor TCustomSetting_DiluentName.Create(const aKey, aDescription: string;
    aOnAddEditFunctions: TNotifyEvent);
begin
    inherited Create(aKey, aDescription, true, cpeDiluentName, aOnAddEditFunctions);
end;

{ TCustomSetting_DilNameArrayRefToRackPos }

constructor TCustomSetting_DilNameArrayRefToRackPos.Create(const aKey, aDescription: string;
    aOnAddEditFunctions: TNotifyEvent; aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, TLanguageString.Read('Diluent', 'Lösemittel'), 120,
        cpeDilNameArrayRefToRackPos, aOnAddEditFunctions, aOnGetEditFunctionParams);
end;

{ TCustomSetting_DiluentRack }

constructor TCustomSetting_DiluentRack.Create(const aKey, aDescription: string;
    aOnAddEditFunctions: TNotifyEvent; aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, true, cpeDiluentRack, aOnAddEditFunctions, aOnGetEditFunctionParams);
end;

{ TCustomSetting_DilRackArrayRefToRackPos }

constructor TCustomSetting_DilRackArrayRefToRackPos.Create(const aKey, aDescription: string;
    aOnAddEditFunctions: TNotifyEvent; aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, TLanguageString.Read('Diluent Rack', 'Lösemittel-Rack'), 120,
        cpeDilRackArrayRefToRackPos, aOnAddEditFunctions, aOnGetEditFunctionParams);
end;
...
{ TCustomSetting_LiqParamArrayRefToRackPos }

constructor TCustomSetting_LiqParamArrayRefToRackPos.Create(const aKey, aDescription: string;
    aOnAddEditFunctions: TNotifyEvent; aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, TLanguageString.Read('Liq.Handling', 'Liq.Handling'), 120,
        cpeLiqParamArrayRefToRackPos, aOnAddEditFunctions, aOnGetEditFunctionParams);
end;
...
{ TCustomSetting_PosOfRackPosArray }

constructor TCustomSetting_PosOfRackPosArray.Create(const aKey: string; const aDescription: string;
    aOnAddEditFunctions: TNotifyEvent; aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, true, cpePosOfRackPosArray, aOnAddEditFunctions,
        aOnGetEditFunctionParams);
end;

{ TCustomSetting_PosArrayRefToRackPos }

constructor TCustomSetting_PosArrayRefToRackPos.Create(const aKey, aDescription, aColumnDescription: string;
    aOnAddEditFunctions: TNotifyEvent; aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, aColumnDescription, 80, cpePosArrayRefToRackPos, aOnAddEditFunctions,
        aOnGetEditFunctionParams);
end;
...
{ TCustomSetting_RackOfRackPosArray }

constructor TCustomSetting_RackOfRackPosArray.Create(const aKey: string; const aDescription: string;
    aOnAddEditFunctions: TNotifyEvent; aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, true, cpeRackOfRackPosArray, aOnAddEditFunctions,
        aOnGetEditFunctionParams);
end;

{ TCustomSetting_RackArrayRefToRackPos }

constructor TCustomSetting_RackArrayRefToRackPos.Create(const aKey, aDescription, aColumnDescription: string;
    aOnAddEditFunctions: TNotifyEvent; aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, aColumnDescription, 120, cpeRackArrayRefToRackPos,
        aOnAddEditFunctions, aOnGetEditFunctionParams);
end;
...
{ TCustomSetting_SubstIDArrayRefToRackPos }

constructor TCustomSetting_SubstIDArrayRefToRackPos.Create(const aKey, aDescription,
    aColumnDescription: string; aOnAddEditFunctions: TNotifyEvent;
    aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, aColumnDescription, 150, cpeSubstIDArrayRefToRackPos,
        aOnAddEditFunctions, aOnGetEditFunctionParams);
end;
...
{ TCustomSetting_TipArrayRefToRackPos }

constructor TCustomSetting_TipArrayRefToRackPos.Create(const aKey, aDescription: string;
    aOnAddEditFunctions: TNotifyEvent; aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, TLanguageString.Read('Tip', 'Nadel'), 60, cpeTipArrayRefToRackPos,
        aOnAddEditFunctions, aOnGetEditFunctionParams);
end;
...
{ TCustomSetting_VolumeRefToRackPosArray }

constructor TCustomSetting_VolumeArrayRefToRackPos.Create(const aKey, aDescription,
    aColumnDescription: string; aOnAddEditFunctions: TNotifyEvent;
    aOnGetEditFunctionParams: TCustomSettingGetEditFunctionParamsEvent);
begin
    inherited Create(aKey, aDescription, aColumnDescription, 80, cpeVolumeArrayRefToRackPos,
        aOnAddEditFunctions, aOnGetEditFunctionParams);
end;
