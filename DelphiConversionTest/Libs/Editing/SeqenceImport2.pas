...
type
    ...
    public
        ...
        procedure ImportData(aLines: TStringValueList; aConstSubstWidth: boolean; aSubstWidth: integer;
            aDelimiter: char);
    end;
...
procedure TSequenceGrid.ImportData(aLines: TStringValueList; aConstSubstWidth: boolean; aSubstWidth: integer;
    aDelimiter: char);
var
    x, xRow: integer;
begin
